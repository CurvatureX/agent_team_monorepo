...
-- Workflow versions for change tracking
...
-- Node execution records - detailed node-level execution data
CREATE TABLE node_executions (
    ...
    -- Data (based on NodeExecutionData protobuf)
    input_data JSONB,
    output_data JSONB,
    error_data JSONB,
...
-- ==============================================================================
-- AI System (Based on AIAgentConfig protobuf)
-- ==============================================================================
...
CREATE TABLE ai_models (
    ...
    -- Configuration (based on AILanguageModel protobuf)
...
-- User OAuth tokens and credentials
...
-- ==============================================================================
-- Trigger System (Based on Trigger protobuf)
-- ==============================================================================
...
CREATE TABLE workflow_triggers (
    ...
    -- Trigger configuration (based on Trigger protobuf)
    trigger_type VARCHAR(100) NOT NULL,  -- WEBHOOK, SCHEDULE, EVENT, etc.
...
-- ==============================================================================
-- Debugging and Validation System
-- ==============================================================================
...
CREATE TABLE validation_logs (
    ...
    -- Validation details
    validation_type VARCHAR(50) NOT NULL,  -- 'workflow', 'node', 'connection'
...
CREATE TABLE debug_sessions (
    ...
    session_type VARCHAR(50) NOT NULL DEFAULT 'manual',  -- manual, auto, test
...
-- ==============================================================================
-- Memory and Knowledge System (Based on Memory protobuf)
-- ==============================================================================
...
CREATE TABLE workflow_memory (
    ...
    memory_value JSONB,
    memory_type VARCHAR(50) DEFAULT 'runtime',  -- runtime, persistent, shared
