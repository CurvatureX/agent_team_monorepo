...
resource "aws_ssm_parameter" "smtp_username" {
  ...
  type  = "SecureString"
  value = var.smtp_username != "" ? var.smtp_username : "placeholder"
...
resource "aws_ssm_parameter" "github_app_id" {
  ...
  type  = "SecureString"
  value = var.github_app_id != "" ? var.github_app_id : "placeholder"
...
resource "aws_ssm_parameter" "github_app_private_key" {
  ...
  type  = "SecureString"
  value = var.github_app_private_key != "" ? var.github_app_private_key : "placeholder"
...
resource "aws_ssm_parameter" "github_webhook_secret" {
  ...
  type  = "SecureString"
  value = var.github_webhook_secret != "" ? var.github_webhook_secret : "placeholder"
