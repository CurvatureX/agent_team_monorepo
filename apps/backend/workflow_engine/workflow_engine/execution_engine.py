...
class EnhancedWorkflowExecutionEngine:
                    ...
                    if node_def:
                        ...
                        if error_handling == "STOP_WORKFLOW_ON_ERROR":
                            ...
                            self._record_execution_error(
                                execution_id, "node_execution", [f"Node {node_id} failed"]
                            )
                            break
    ...
    def _initialize_enhanced_execution_state(
        ...
        return {
            ...
            "execution_context": {
                ...
                "triggered_by": "system",
                "trigger_data": initial_data or {},  # Store trigger data for node access
                "metadata": {},
            },
            "performance_metrics": {
    ...
    def _execute_node_with_enhanced_tracking(
        ...
        # Get trigger data from execution context for node access
        ...
        context = NodeExecutionContext(
            ...
            metadata={
                ...
                "trigger_data": trigger_data,  # Pass trigger data to node context
                "trigger_channel_id": trigger_data.get("channel_id"),  # Easy access to channel
                "trigger_user_id": trigger_data.get("user_id"),  # Easy access to user
            },
        )
