...
class UnifiedGRPCServer:
    ...
    def create_server(self) -> grpc.Server:
        ...
        workflow_service_pb2_grpc.add_WorkflowServiceServicer_to_server(main_service, server)
    ...
    def start(self):
        ...
        try:
            ...
            logger.info(
                f"🌐 Server listening on: {self.settings.grpc_host}:{self.settings.grpc_port}"
            )
