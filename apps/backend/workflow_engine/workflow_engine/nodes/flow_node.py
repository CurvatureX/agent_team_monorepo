...
class FlowNodeExecutor(BaseNodeExecutor):
    ...
    def _execute_if_condition(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
    ...
    def _execute_filter(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
    ...
    def _execute_loop(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
    ...
    def _execute_merge(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
    ...
    def _execute_switch(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
        ...
        if not matched_case:
            ...
            matched_case = next((case for case in switch_cases if case.get("is_default", False)), None)
    ...
    def _execute_wait(self, context: NodeExecutionContext, logs: List[str], start_time: float) -> NodeExecutionResult:
    ...
    def _execute_while_loop(self, data: Dict[str, Any], condition: str, max_iterations: int) -> Dict[str, Any]:
        """Execute while loop."""
        iterations = 0
    ...
    def _intersection_data(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"intersection": True, "source_data": data, "intersection_at": datetime.now().isoformat()} 