...
-- Table for episodic events (using TimescaleDB hypertable pattern)
...
CREATE INDEX IF NOT EXISTS idx_episodic_events_actor ON episodic_events(actor);
CREATE INDEX IF NOT EXISTS idx_episodic_events_action ON episodic_events(action);
...
-- Vector similarity index for episodic events
...
-- =====================================================
-- 6. GRAPH MEMORY (using adjacency lists in PostgreSQL)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS documents (
    ...
    -- Unique constraint on document_id per collection
    UNIQUE (document_id, collection_name, user_id)
);
...
-- =====================================================
-- 8. VECTOR DATABASE MEMORY (using pgvector)
-- =====================================================
...
-- =====================================================
-- 9. DOCUMENT STORE MEMORY (Updated Schema)
-- =====================================================

-- Update document store schema to match implementation
...
-- =====================================================
-- 10. EPISODIC MEMORY (Updated Schema)
-- =====================================================

-- Update episodic memory schema to match implementation
...
BEGIN
    ...
    WHERE created_at < (CURRENT_TIMESTAMP - INTERVAL '%s days' % retention_days);
