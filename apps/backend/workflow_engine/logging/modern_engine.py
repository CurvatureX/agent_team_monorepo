...
from shared.models.workflow import Node, Workflow
...
class ModernExecutionEngine:
        ...
        try:
            ...
            if hasattr(runner, "run_async"):
                ...
                result_data = await loop.run_in_executor(
                    None, runner.run, node, input_data, context
                )
            ...
            if node.type.value == "HUMAN_IN_THE_LOOP":
    ...
    def _validate_workflow(self, workflow: Workflow):
        ...
        # Validate that all nodes have valid specs
    ...
    def _are_dependencies_ready(
        ...
        for pred_id in predecessors:
            if pred_id not in results or not results[pred_id].success:
                return False
