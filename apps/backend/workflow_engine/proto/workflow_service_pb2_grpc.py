...
class WorkflowServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TestNode = channel.unary_unary(
                ...
                _registered_method=True)
        self.ListAllNodeTemplates = channel.unary_unary(
                '/proto.WorkflowService/ListAllNodeTemplates',
                request_serializer=workflow__service__pb2.ListAllNodeTemplatesRequest.SerializeToString,
                response_deserializer=workflow__service__pb2.ListAllNodeTemplatesResponse.FromString,
                _registered_method=True)
...
class WorkflowServiceServicer(object):
    ...
    def ListAllNodeTemplates(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_WorkflowServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListAllNodeTemplates': grpc.unary_unary_rpc_method_handler(
                    servicer.ListAllNodeTemplates,
                    request_deserializer=workflow__service__pb2.ListAllNodeTemplatesRequest.FromString,
                    response_serializer=workflow__service__pb2.ListAllNodeTemplatesResponse.SerializeToString,
            ),
    }
...
class WorkflowService(object):
    ...
    @staticmethod
    def ListAllNodeTemplates(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/proto.WorkflowService/ListAllNodeTemplates',
            workflow__service__pb2.ListAllNodeTemplatesRequest.SerializeToString,
            workflow__service__pb2.ListAllNodeTemplatesResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
