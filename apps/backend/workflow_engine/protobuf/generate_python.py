...
def fix_import_statements(output_dir):
    ...
    for filename in files_to_fix:
        ...
        if filepath.exists():
            ...
            content = re.sub(r"from \. import \. import", "from . import", content)
...
def generate_python_code():
    ...
    shared_proto_dir = Path(
        "/Users/bytedance/Workspace/agent_team_monorepo/apps/backend/shared/proto/engine"
    )
