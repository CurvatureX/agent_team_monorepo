...
class TestNodeIdGenerator:
    ...
    def test_ensure_unique_node_ids_no_changes(self):
        ...
        nodes = [
            {"id": "trigger_manual_12345678", "name": "Start", "type": "TRIGGER", "subtype": "MANUAL"},
            {"id": "action_http_87654321", "name": "API Call", "type": "ACTION", "subtype": "HTTP_REQUEST"},
        ]
    ...
    def test_ensure_unique_node_ids_empty_ids(self):
        ...
        nodes = [
            {"id": "", "name": "Start", "type": "TRIGGER", "subtype": "MANUAL"},
            {"id": None, "name": "API Call", "type": "ACTION", "subtype": "HTTP_REQUEST"},
            {"name": "End", "type": "ACTION", "subtype": "DATA_TRANSFORMATION"},  # No id field
        ]
    ...
    def test_ensure_unique_node_ids_duplicates(self):
        ...
        nodes = [
            {"id": "node_1", "name": "First", "type": "ACTION", "subtype": "HTTP_REQUEST"},
            {"id": "node_1", "name": "Second", "type": "ACTION", "subtype": "HTTP_REQUEST"},
            {"id": "node_1", "name": "Third", "type": "TRIGGER", "subtype": "MANUAL"},
        ]
    ...
    def test_ensure_unique_node_ids_reserved_keywords(self):
        ...
        nodes = [
            {"id": "start", "name": "Start Node", "type": "TRIGGER", "subtype": "MANUAL"},
            {"id": "end", "name": "End Node", "type": "ACTION", "subtype": "HTTP_REQUEST"},
            {"id": "workflow", "name": "Workflow Node", "type": "ACTION", "subtype": "DATA_TRANSFORMATION"},
        ]
        ...
        connections = {
            ...
            "old_node_2": {
                "connection_types": {
                    "main": {
                        "connections": [
                            {"node": "old_node_3", "type": "main", "index": 0}
                        ]
                    }
                }
            },
    ...
    def test_migrate_legacy_ids(self):
        ...
        nodes = [
            {"id": "http_request_google", "name": "Google Request", "type": "ACTION", "subtype": "HTTP_REQUEST"},
            {"id": "if_condition", "name": "Check Status", "type": "FLOW", "subtype": "IF"},
            {"id": "1234", "name": "Invalid ID", "type": "TRIGGER", "subtype": "MANUAL"},
        ]
