...
def test_workflow_execution():
    ...
    try:
        ...
        ai_agent_node = workflow_pb2.Node(
            ...
            parameters={"model": "gpt-4", "temperature": "0.7", "max_tokens": "1000"},
        )
        ...
        action_node = workflow_pb2.Node(
            ...
            parameters={"url": "https://httpbin.org/get", "method": "GET", "headers": "{}"},
        )
        ...
        main_connection = workflow_pb2.Connection(
            node="Task Analyzer", type=workflow_pb2.ConnectionType.MAIN, index=0
        )
        ...
        ai_main_connection = workflow_pb2.Connection(
            node="HTTP Request", type=workflow_pb2.ConnectionType.MAIN, index=0
        )
        ...
        if "execution_response" in locals() and execution_response.execution_id:
            ...
            try:
                ...
                if status_response.found:
                    ...
                    print(
                        f"   Progress: {execution.start_time}"
                    )  # Use start_time as progress indicator
