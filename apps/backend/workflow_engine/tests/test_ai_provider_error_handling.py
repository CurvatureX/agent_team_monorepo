...
class TestOpenAIProviderErrorHandling:
    ...
    def test_auth_error_detection(self):
        ...
        with patch('openai.OpenAI') as mock_client:
            ...
            mock_instance.chat.completions.create.side_effect = AuthenticationError("Invalid API key")
    ...
    def test_rate_limit_error_detection(self):
        ...
        with patch('openai.OpenAI') as mock_client:
            ...
            mock_instance.chat.completions.create.side_effect = RateLimitError("Rate limit exceeded")
    ...
    def test_short_response_detection(self):
        ...
        is_error, _ = provider.detect_error_in_content("This is a normal response with sufficient content.")
        assert not is_error
