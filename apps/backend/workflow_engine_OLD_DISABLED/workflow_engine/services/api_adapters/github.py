...
class GitHubAdapter(APIAdapter):
    ...
    async def call(
        ...
        try:
            self.logger.info(
                f"GitHub operation: {operation} with params: {list(parameters.keys())}"
            )
    ...
    async def _add_comment(
        ...
        comment_data = {"body": parameters["body"]}
    ...
    async def _list_issues(
        ...
        return {"success": True, "total_count": len(issues), "issues": issues, "repository": repo}
