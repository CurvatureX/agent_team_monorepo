...
class NodeIdGenerator:
    ...
    def ensure_unique_node_ids(cls, nodes: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for node in nodes:
            ...
            needs_new_id = (
                ...
                or current_id.lower() in cls.RESERVED_IDS
                or not cls.is_valid_node_id(current_id)
            )
    ...
    def generate_node_id(
        cls, node_type: str, node_subtype: str, node_name: str, existing_ids: Set[str]
    ) -> str:
        """
    ...
    def resolve_connection_references(
        cls, connections: Dict[str, Any], name_to_id_mapping: Dict[str, str], node_ids: Set[str]
    ) -> Dict[str, Any]:
        """
        ...
        for source_ref, connection_data in connections.items():
            ...
            updated_connection_data = {"connection_types": {}}

            for conn_type, conn_list in connection_data.get("connection_types", {}).items():
                updated_conn_list = {"connections": []}
    ...
    def update_connection_references(
        cls, connections: Dict[str, Any], id_mapping: Dict[str, str]
    ) -> Dict[str, Any]:
        """
