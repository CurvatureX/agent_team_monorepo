...
from app.api.app import chat, sessions
...
# router.include_router(workflows.router, prefix="/workflows", tags=["App - Workflows"])  # Temporarily disabled due to proto issues
