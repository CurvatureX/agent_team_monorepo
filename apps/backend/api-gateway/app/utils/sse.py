...
async def create_mock_chat_stream(session_id: str, message: str) -> AsyncGenerator[Dict[str, Any], None]:
    ...
    is_workflow_request = any(keyword in message.lower() for keyword in [
        'workflow', 'automation', 'create', 'generate', 'build'
    ])
...
async def _yield_workflow_generation_in_chat(session_id: str) -> AsyncGenerator[Dict[str, Any], None]:
    """
    ...
    analysis_response = "I understand you want to create a workflow. Let me analyze your requirements..."
