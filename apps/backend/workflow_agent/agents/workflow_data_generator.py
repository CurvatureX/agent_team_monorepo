...
class WorkflowDataGenerator:
    ...
    def _analyze_workflow_inputs(self, workflow_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for node in nodes:
            ...
            # Identify trigger nodes and their inputs
            if node_type in ["trigger", "TRIGGER_NODE", "webhook", "manual"]:
            ...
            # Identify nodes that need external data
            if node_type in ["ai_agent", "AI_AGENT_NODE", "external_action", "EXTERNAL_ACTION_NODE"]:
