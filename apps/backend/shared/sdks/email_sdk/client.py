...
class EmailSDK(BaseSDK):
    ...
    def get_oauth2_config(self) -> OAuth2Config:
        ...
        return OAuth2Config(
            ...
            redirect_uri=os.getenv("GMAIL_REDIRECT_URI", "http://localhost:8002/api/v1/oauth2/gmail/callback")
        )
    ...
    async def _send_email(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
        """Send email message."""
    ...
    async def _send_html_email(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
        """Send HTML email."""
    ...
    async def _send_template_email(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
    ...
    async def _validate_email(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
    ...
    async def _test_smtp_connection(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
    ...
    def _send_via_smtp(self, email_msg: EmailMessage, credentials: Dict[str, str]) -> Dict[str, Any]:
        """Send email via SMTP."""
        try:
            ...
            if email_msg.attachments:
                for attachment in email_msg.attachments:
                    ...
                    att_part['Content-Disposition'] = f'attachment; filename="{attachment.filename}"'
