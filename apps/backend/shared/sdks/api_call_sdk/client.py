...
class ApiCallSDK(BaseSDK):
    ...
    def get_oauth2_config(self) -> OAuth2Config:
        ...
        return OAuth2Config(
            ...
            redirect_uri=os.getenv("API_CALL_REDIRECT_URI", "http://localhost:8002/api/v1/oauth2/api_call/callback")
        )
    ...
    def get_custom_oauth2_config(self, provider: str) -> OAuth2Config:
        ...
        provider_configs = {
            ...
            "microsoft": OAuth2Config(
                ...
                revoke_url="",
                scopes=["openid", "email", "profile"],
                redirect_uri=os.getenv("MICROSOFT_REDIRECT_URI", "http://localhost:8002/api/v1/oauth2/microsoft/callback")
            ),
            "facebook": OAuth2Config(
                ...
                redirect_uri=os.getenv("FACEBOOK_REDIRECT_URI", "http://localhost:8002/api/v1/oauth2/facebook/callback")
            )
        }
