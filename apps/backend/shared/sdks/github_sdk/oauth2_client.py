...
class GitHubOAuth2SDK(BaseSDK):
    ...
    def get_oauth2_config(self) -> OAuth2Config:
        ...
        return OAuth2Config(
            ...
            redirect_uri=os.getenv("GITHUB_REDIRECT_URI", "http://localhost:8002/api/v1/oauth2/github/callback")
        )
    ...
    async def _merge_pr(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
    ...
    async def _get_file(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
        """Get file content."""
        raise NotImplementedError("Get file not yet implemented")
    
    async def _create_file(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
        """Create file in repository."""
        raise NotImplementedError("Create file not yet implemented")
    
    async def _update_file(self, parameters: Dict[str, Any], credentials: Dict[str, str]) -> Dict[str, Any]:
