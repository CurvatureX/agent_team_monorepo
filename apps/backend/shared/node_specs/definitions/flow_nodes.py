...
FILTER_NODE_SPEC = NodeSpec(
    ...
    parameters=[
        ...
        ParameterDef(
            ...
            required=False,
            default_value="javascript",
            enum_values=["javascript", "jsonpath", "regex", "simple"],
        ...
        ParameterDef(
            ...
            description="Include or exclude matching items",
        ),
        ParameterDef(
            ...
            required=False,
            default_value="true",
            description="Preserve original data structure",
        ),
    ],
    input_ports=[
        InputPortSpec(
...
MERGE_NODE_SPEC = NodeSpec(
    ...
    parameters=[
        ParameterDef(
            ...
            enum_values=["concat", "union", "intersection", "join", "custom"],
            description="Strategy for merging data",
        ),
        ParameterDef(
            name="join_key",
            type=ParameterType.STRING,
            required=False,
            description="Key to use for join operations",
        ),
        ParameterDef(
            name="wait_for_all",
            type=ParameterType.BOOLEAN,
            required=False,
            default_value="true",
            description="Wait for all inputs before merging",
        ),
        ParameterDef(
            ...
            required=False,
            default_value="300",
            description="Timeout for waiting for all inputs",
        ),
    ],
    input_ports=[
        InputPortSpec(
