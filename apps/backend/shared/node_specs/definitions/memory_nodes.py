...
SIMPLE_MEMORY_SPEC = NodeSpec(
    ...
    parameters=[
        ...
        ParameterDef(
            ...
            type=ParameterType.STRING,
            required=True,
            description="Key for the storage operation",
        ),
        ParameterDef(
            name="provider",
            type=ParameterType.ENUM,
            ...
            description="Key-value storage provider",
        ),
        ParameterDef(
            name="ttl_seconds",
            type=ParameterType.INTEGER,
...
BUFFER_MEMORY_SPEC = NodeSpec(
    ...
    parameters=[
        ParameterDef(
            ...
            type=ParameterType.ENUM,
            required=True,
            enum_values=["append", "get", "clear", "get_last_n"],
        ...
        ParameterDef(
            ...
            type=ParameterType.STRING,
            required=True,
            description="Name of the buffer to operate on",
        ),
        ParameterDef(
            name="max_size",
            type=ParameterType.INTEGER,
        ...
        ParameterDef(
            ...
            type=ParameterType.INTEGER,
            required=False,
            description="Number of items to retrieve (for get_last_n)",
        ),
    ],
    input_ports=[
        InputPortSpec(
...
KNOWLEDGE_MEMORY_SPEC = NodeSpec(
    ...
    parameters=[
        ...
        ParameterDef(
            ...
            type=ParameterType.STRING,
            required=False,
            description="Knowledge category or domain",
        ),
        ParameterDef(
            name="tags",
            type=ParameterType.JSON,
