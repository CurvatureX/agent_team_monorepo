...
SLACK_HUMAN_LOOP_SPEC = NodeSpec(
    ...
    parameters=[
        ...
        ParameterDef(
            ...
            type=ParameterType.STRING,
            required=True,
            description="Message template with placeholders for dynamic content",
        ),
        ParameterDef(
            ...
            required=False,
            default_value="60",
            description="Minutes to wait for response before timeout",
        ),
        ParameterDef(
            ...
            required=False,
            default_value="true",
            description="Include approve/reject buttons in message",
        ),
    ],
    input_ports=[
        InputPortSpec(
