...
class TestWorkflowAgentStateManager:
    ...
    def test_save_full_state_operation(self):
        ...
        success = mock_manager.save_full_state(
            session_id="test_session_123", workflow_state=full_state
        )
    ...
    def test_workflow_context_handling(self):
        ...
        # Test create context
        create_context = {"origin": "create", "source_workflow_id": ""}

        assert create_context["origin"] == "create"
        assert create_context["source_workflow_id"] == ""

        # Test edit context
        edit_context = {"origin": "edit", "source_workflow_id": "existing_workflow_123"}

        assert edit_context["origin"] == "edit"
        assert edit_context["source_workflow_id"] == "existing_workflow_123"

        # Test copy context
        copy_context = {"origin": "copy", "source_workflow_id": "template_workflow_456"}
    ...
    def test_workflow_generation_state(self):
        ...
        workflow_state = {
            ...
            "current_workflow": {
                ...
                "nodes": [
                    {"id": "start", "type": "trigger", "name": "CSV Upload Trigger"},
                    {"id": "validate", "type": "action", "name": "Validate CSV Format"},
                    {"id": "process", "type": "action", "name": "Process Customer Data"},
                ],
                "connections": [
