...
class SlackAdapter(APIAdapter):
    ...
    async def _send_message(
        ...
        """发送Slack消息"""
        # 构建消息数据
        message_data = {"channel": parameters["channel"], "text": parameters["message"]}
    ...
    async def _delete_message(
        ...
        """删除Slack消息"""
        message_data = {"channel": parameters["channel"], "ts": parameters["ts"]}
    ...
    async def _upload_file(
        ...
        """上传文件到Slack"""
        file_data = {"channels": parameters["channels"], "content": parameters["file_content"]}
    ...
    async def _get_user_info(
        ...
        """获取用户信息"""
        user_data = {"user": parameters["user_id"]}
