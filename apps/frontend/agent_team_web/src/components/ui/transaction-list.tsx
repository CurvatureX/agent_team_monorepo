...
const Component = ({ transactions }: { transactions: Transaction[] }) => {
      ...
      >
        <AnimatePresence mode="wait">
          {!selectedTransaction ? (
            ...
            >
              <h2 className="pl-6 pt-3 text-xl font-semibold text-muted-foreground">Transactions</h2>
                ...
                {transactions.map((transaction) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <motion.p layoutId={`name-${transaction.id}`} className="font-medium text-foreground">
                          {transaction.name}
                        </motion.p>
                        <motion.p
            ...
            >
              ...
              <div className="flex justify-between border-b border-border border-dashed pb-4">
                <div className="space-y-1">
                  <motion.p layoutId={`name-${selectedTransaction.id}`} className="font-medium text-foreground">
              ...
              >
                ...
                <div className="border-t border-border border-dashed pt-4 text-muted-foreground">
                  <p className="font-medium text-foreground">Paid Via {selectedTransaction.paymentMethod}</p>
